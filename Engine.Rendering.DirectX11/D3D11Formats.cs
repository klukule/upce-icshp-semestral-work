...
namespace Engine.Rendering.D3D11
{
    internal static class D3D11Formats
    {
        ...
        internal static BindFlags ToD3D11BindFlags(BufferUsage usage)
        {
        ...
        internal static PixelFormat ToEngineFormat(Format format)
        {
            switch (format)
            {
        ...
        internal static TextureSampleCount ToEngineSampleCount(SampleDescription sampleDescription)
        {
            switch (sampleDescription.Count)
            {
                ...
                default: throw new RendererException("Unsupported multisample count: " + sampleDescription.Count);
            }
        }

        internal static BlendOperation ToD3D11BlendOperation(BlendFunction function)
        {
            switch (function)
            {
        ...
        internal static SharpDX.Direct3D11.MapMode ToD3D11MapMode(bool isDynamic, MapMode mode)
        {
            switch (mode)
            {
                case MapMode.Read:
        ...
        internal static SharpDX.Direct3D.PrimitiveTopology ToD3D11PrimitiveTopology(PrimitiveTopology primitiveTopology)
        {
        ...
        internal static FillMode ToD3D11FillMode(PolygonFillMode fillMode)
        {
            switch (fillMode)
            {
        ...
        internal static Comparison ToD3D11Comparison(ComparisonKind comparisonKind)
        {
        ...
        internal static TextureAddressMode ToD3D11AddressMode(SamplerAddressMode mode)
        {
            switch (mode)
            {
        ...
        internal static Format GetDepthFormat(PixelFormat format)
        {
            switch (format)
            {
                ...
                default:
                    throw new RendererException("Invalid depth texture format: " + format);
            }
        }
    }
}