...
namespace Engine.Rendering.D3D11
{
    internal class D3D11ResourceCache : IDisposable
    {
        ...
        private struct D3D11RasterizerStateCacheKey : IEquatable<D3D11RasterizerStateCacheKey>
        {
            ...
            public D3D11RasterizerStateCacheKey(RasterizerStateDescription description, bool multisampled)
            {
            ...
            public override int GetHashCode()
            {
                return HashHelper.Combine(Description.GetHashCode(), Multisampled.GetHashCode());
            }
        }
    }
}